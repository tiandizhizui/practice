      ...
      <div class="navbar-collapse">
            <nav class="left_bar_position left_bar_decoration">
                ...
                <ul class="nav" id="side-menu">
                    <li>
                        <a href="myIndex.html"><i class="fa fa-home nav_icon"></i>主 页</a>
                    </li>
                    <li>
                        <a href="#" data-toggle="collapse"><i class="fa fa-cogs nav_icon"></i>Components
                            <span class="nav-badge">12</span>
                            <i class="glyphicon glyphicon-arrow-down"></i>
                        </a>
                        <ul class="nav nav-second-level collapse" id="usermenue">
                            <li>
